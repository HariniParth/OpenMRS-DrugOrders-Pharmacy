                                    ...
                                    <% planMain.value.each { orderMain -> %>
                                        <div class="planDrug">
                                            ...
                                            <div class="planDetails">
                                                ...
                                                <div id="planDrugName" onclick="showDrugOrderViewWindow('VIEW ORDER','${ NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).startDate.format('yyyy-MM-dd') }','${ NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).drugName.getDisplayString() }','${ orderMain.value.dose }','${ orderMain.value.doseUnits.getDisplayString() }','${ orderMain.value.route.getDisplayString() }','${ orderMain.value.duration }','${ orderMain.value.durationUnits.getDisplayString() }','${ orderMain.value.quantity }','${ orderMain.value.quantityUnits.getDisplayString() }','${ orderMain.value.frequency }','${ NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).refill }','${ NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).isAllergicOrderReasons }','${ default_prio }','${ NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).patientInstructions }','${ NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).pharmacistInstructions }')">   
