                                    ...
                                    <div class="plansDetailsView">
                                        <% drugOrderMain.value.each { drugOrderMn -> %>
                                            ...
                                            <div class="planDrug">
                                                ...
                                                <div class="planDrugDetails" onclick="showDrugOrderViewWindow('${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).startDate.format('yyyy-MM-dd') }','${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).drugName.getDisplayString() }','${ drugOrderMn.value.dose }','${ drugOrderMn.value.doseUnits.getDisplayString() }','${ drugOrderMn.value.route.getDisplayString() }','${ drugOrderMn.value.duration }','${ drugOrderMn.value.durationUnits.getDisplayString() }','${ drugOrderMn.value.quantity }','${ drugOrderMn.value.quantityUnits.getDisplayString() }','${ drugOrderMn.value.frequency }','${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).refill }','${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).refillInterval }','${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).isAllergicOrderReasons }','${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).associatedDiagnosis.getDisplayString() }','${ default_prio }','${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).patientInstructions }','${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).pharmacistInstructions }','${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).commentForOrderer }','${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).orderStatus }','${ Orderer.get(DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).orderId) }')">   
                                                    <div id="planDrugId">
                                                        ${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).orderId } <% if(Orders.get(DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).orderId).previousOrder != null) { %> <br/><div class="prevOrderID">(${ Orders.get(DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).orderId).previousOrder.orderId })</div> <% } %>
                                                    </div>
                                ...
                                <div class="plansDetailsView">
                                    <% drugOrderMain.value.each { drugOrderMn -> %>
                                        ...
                                        <div class="planDrug <% if(ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).forDiscard == 1) { %> discontinued <% } %> <% if(ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).onHold == 1) { %> onhold <% } %>" title="${ ui.message(ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).commentForOrderer) }">
                                            ...
                                            <div class="planDrugDetails" onclick="showDrugOrderViewWindow('${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).startDate.format('yyyy-MM-dd') }','${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).drugName.getDisplayString() }','${ drugOrderMn.value.dose }','${ drugOrderMn.value.doseUnits.getDisplayString() }','${ drugOrderMn.value.route.getDisplayString() }','${ drugOrderMn.value.duration }','${ drugOrderMn.value.durationUnits.getDisplayString() }','${ drugOrderMn.value.quantity }','${ drugOrderMn.value.quantityUnits.getDisplayString() }','${ drugOrderMn.value.frequency }','${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).refill }','${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).refillInterval }','${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).isAllergicOrderReasons }','${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).associatedDiagnosis.getDisplayString() }','${ default_prio }','${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).patientInstructions }','${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).pharmacistInstructions }','${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).commentForOrderer }','${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).orderStatus }','${ Orderer.get(ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).orderId) }')">   
                                                <div id="planDrugId">
                                                    ${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).orderId } <% if(Orders.get(ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).orderId).previousOrder != null) { %> <br/><div class="prevOrderID">(${ Orders.get(ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).orderId).previousOrder.orderId })</div> <% } %>
                                                </div>
