                                        ...
                                        <% drugOrderMain.value.each { drugOrderMn -> %>
                                            ...
                                            <div class="planDrug">
                                                ...
                                                <div id="button" class="pull-right">
                                                    <i class="icon-edit edit-action" title="${ ui.message("Edit") }" onclick="editSingleOrderDetailsWindow('EDIT DRUG ORDER','${ drugOrderMn.value.orderId }','${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).drugName.getDisplayString() }','${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).startDate }','${ drugOrderMn.value.dose }','${ drugOrderMn.value.doseUnits.getDisplayString() }','${ drugOrderMn.value.route.getDisplayString() }','${ drugOrderMn.value.duration }','${ drugOrderMn.value.durationUnits.getDisplayString() }','${ drugOrderMn.value.quantity }','${ drugOrderMn.value.quantityUnits.getDisplayString() }','${ drugOrderMn.value.frequency }','${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).refill }','${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).refillInterval }','${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).associatedDiagnosis.getDisplayString().toUpperCase() }','${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).isAllergicOrderReasons }','${ default_prio }','${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).patientInstructions }','${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).pharmacistInstructions }','${ DraftPlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).orderStatus }','${ allergicDrugs }')"></i>
                                ...
                                <div class="plansDetailsView">
                                    <% drugOrderMain.value.each { drugOrderMn -> %>
                                        ...
                                        <div class="planDrug <% if(ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).forDiscard == 1) { %> discontinued <% } %> <% if(ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).onHold == 1) { %> onhold <% } %>" title="${ ui.message(ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).commentForOrderer) }">
                                            ...
                                            <div class="planDrugDetails" onclick="showDrugOrderViewWindow('VIEW ORDER','${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).startDate.format('yyyy-MM-dd') }','${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).drugName.getDisplayString() }','${ drugOrderMn.value.dose }','${ drugOrderMn.value.doseUnits.getDisplayString() }','${ drugOrderMn.value.route.getDisplayString() }','${ drugOrderMn.value.duration }','${ drugOrderMn.value.durationUnits.getDisplayString() }','${ drugOrderMn.value.quantity }','${ drugOrderMn.value.quantityUnits.getDisplayString() }','${ drugOrderMn.value.frequency }','${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).refill }','${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).isAllergicOrderReasons }','${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).associatedDiagnosis.getDisplayString() }','${ default_prio }','${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).patientInstructions }','${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).pharmacistInstructions }','${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).commentForOrderer }','${ ActivePlanExtn.get(drugOrderMain.key).get(drugOrderMn.key).orderStatus }')">   
                                                <div id="planDrugId">
