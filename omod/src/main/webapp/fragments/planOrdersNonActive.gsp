                                    ...
                                    <% planMain.value.each { orderMain -> %>
                                        <div class="planDrug">
                                            ...
                                            <div class="planDetails">
                                                <div id="planDrugId">
                                                    ${ NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).orderId } <% if(Orders.get(NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).orderId).previousOrder != null) { %> <br/><div class="prevOrderID">(${ Orders.get(NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).orderId).previousOrder.orderId })</div> <% } %>
                                                </div>
                                                
                                                <div id="planDrugName" onclick="showDrugOrderViewWindow('${ NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).startDate.format('yyyy-MM-dd') }','${ NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).drugName.getDisplayString() }','${ orderMain.value.dose }','${ orderMain.value.doseUnits.getDisplayString() }','${ orderMain.value.route.getDisplayString() }','${ orderMain.value.duration }','${ orderMain.value.durationUnits.getDisplayString() }','${ orderMain.value.quantity }','${ orderMain.value.quantityUnits.getDisplayString() }','${ orderMain.value.frequency }','${ NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).refill }','${ NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).refillInterval }','${ NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).isAllergicOrderReasons }','${ NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).associatedDiagnosis.getDisplayString() }','${ default_prio }','${ NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).patientInstructions }','${ NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).pharmacistInstructions }','${ NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).commentForOrderer }','${ NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).orderStatus }','${ Orderer.get(NonActivePlanExtn.get(planOrderMain.key).get(planMain.key).get(orderMain.key).orderId) }')">   
